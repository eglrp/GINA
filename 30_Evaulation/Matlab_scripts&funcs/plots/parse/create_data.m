...
function p_data = create_data(fileName) % p_data = .gina data
%% reada a .gina file into a struct of h_data and d_data. 
%( h_data ->header , d_data -> the rest of the .gina file):
h_data = read_header(fileName);

data = read_data(fileName);
d_data = make_gina_format(data,h_data);
